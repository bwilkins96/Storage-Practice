...
function restoreTheme() {
    //let currentTheme = document.cookie.split("=")[1];
    let cookie = getCookie("theme");
    let currentTheme;
    if (cookie) {currentTheme = cookie.split("=")[1];}
...
function restoreName() {
    ...
    let currentName;
    if (cookie) {currentName = cookie.split("=")[1]};

    if (currentName) {setInputValue("display-name", currentName)}
}
